...
<head>
    ...
    <title>Pertanyaan 8</title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-dark shadow fixed-top">
  <div class="container justify-content-center navs ">
    <a class="navbar-brand" href="#"><span id="co1"><i class="fas fa-file-alt"></i></span>&nbsp;&nbsp;Pertanyaan 08/10</a>
  </div>
</nav>
    ...
    <div class="container text-center">
        <div class="row">
             <div class="col-12 col-md-12">
                <h2>Apakah anda selalu membersihkan diri/mandi setelah berpergian selama masa pandemi <span id="tanya">?<span></h2>
                <form method="post">
