...
if(isset($_POST['submit'])) {
    $_SESSION['soal_5'] = true;
    soalInput($_POST);
    header("Location: soal_6.php");
}

if(!isset($_SESSION['soal_4'])) {
    header("Location: soal_4.php");
}

if(isset($_SESSION['soal_5'])) {
    header("Location: soal_6.php");
}
...
<head>
    ...
    <title>Pertanyaan 5</title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-dark shadow fixed-top">
  <div class="container justify-content-center navs ">
    <a class="navbar-brand" href="#"><span id="co1"><i class="fas fa-file-alt"></i></span>&nbsp;&nbsp;Pertanyaan 05/10</a>
  </div>
</nav>
    ...
    <div class="container text-center">
        <div class="row">
             <div class="col-12 col-md-12">
                <h2>Apakah penerapan social distancing atau physical distancing selama masa pandemi sudah anda terapkan <span id="tanya">?<span></h2>
                <form method="post">
