...
if(isset($_POST['submit'])) {
    $_SESSION['soal_7'] = true;
    soalInput($_POST);
    header("Location: soal_8.php");
}

if(!isset($_SESSION['soal_6'])) {
    header("Location: soal_6.php");
}

if(isset($_SESSION['soal_7'])) {
    header("Location: soal_8.php");
}
...
<head>
    ...
    <title>Pertanyaan 7</title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-dark shadow fixed-top">
  <div class="container justify-content-center navs ">
    <a class="navbar-brand" href="#"><span id="co1"><i class="fas fa-file-alt"></i></span>&nbsp;&nbsp;Pertanyaan 07/10</a>
  </div>
</nav>
    ...
    <div class="container text-center">
        <div class="row">
             <div class="col-12 col-md-12">
                <h2>Apakah anda selalu menutup mulut dan hidung saat bersin atau batuk untuk dilakukan selama masa pandemi <span id="tanya">?<span></h2>
                <form method="post">
