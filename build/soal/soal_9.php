...
if(isset($_POST['submit'])) {
    $_SESSION['soal_9'] = true;
    soalInput($_POST);
    header("Location: soal_10.php");
}
...
<head>
    ...
    <title>Pertanyaan 9</title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-dark shadow fixed-top">
  <div class="container justify-content-center navs ">
    <a class="navbar-brand" href="#"><span id="co1"><i class="fas fa-file-alt"></i></span>&nbsp;&nbsp;Pertanyaan 09/10</a>
  </div>
</nav>
    ...
    <div class="container text-center">
        <div class="row">
             <div class="col-12 col-md-12">
                <h2>Apakah anda selalu menghindari dari kerumunan ketika berpergian <span id="tanya">?<span></h2>
                <form method="post">
