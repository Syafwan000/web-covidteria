...
$_SESSION['tinggi'] = "tinggi01";
$_SESSION['tinggi2'] = "tinggi02";
    ...
    <div class="container text-center">
        <div class="row">
             <div class="col-12 col-md-12">
                ...
                <h3>Anda Beresiko <span id="tinggi">Tinggi <i class="fas fa-frown-open"></i></span> terpapar Covid-19</h3>
                ...
                <form method="post">
                    <button type="submit" name="submit_tinggi" class="btn btn-success"><i class="fas fa-paper-plane"></i>&nbsp;&nbsp;Selesai</button>
                </form>
             </div>
        </div>
    </div>
