...
$_SESSION['sedang'] = "sedang01";
$_SESSION['sedang2'] = "sedang02";
    ...
    <div class="container text-center">
        <div class="row">
             <div class="col-12 col-md-12">
                ...
                <h3>Anda Beresiko <span id="sedang">Sedang <i class="fas fa-meh"></i></span> terpapar Covid-19</h3>
                ...
                <form method="post">
                    <button type="submit" name="submit_sedang" class="btn btn-success"><i class="fas fa-paper-plane"></i>&nbsp;&nbsp;Selesai</button>
                </form>
             </div>
        </div>
    </div>
